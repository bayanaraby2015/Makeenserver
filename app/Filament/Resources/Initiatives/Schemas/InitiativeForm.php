...
class InitiativeForm
{
    public static function configure(Schema $schema): Schema
    {
        return $schema->components([
            Tabs::make('initiative_form_tabs')
                ->columnSpanFull()
                ->tabs([
                    self::identityTab(),
                    self::outputsTab(),
    ...
    {
        return Tab::make(__('initiatives.tabs.identity'))
                ...
                Section::make(__('initiatives.sections.basic'))
                    ...
                    ->schema([
                        Select::make('organization_id')
                            ...
                            ->relationship('organization', 'name_ar')
    ...
    {
        return Tab::make(__('initiatives.tabs.outputs'))
    ...
    {
        return Tab::make(__('initiatives.tabs.milestones'))
    ...
    {
        return Tab::make(__('initiatives.tabs.payments'))
    ...
    {
        return Tab::make(__('initiatives.tabs.kpis'))
    ...
    {
        return Tab::make(__('initiatives.tabs.risks'))
